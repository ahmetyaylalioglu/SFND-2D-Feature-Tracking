...
int main(int argc, const char *argv[])
{
    ...
    for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex++)
    {
        ...
        int intImageIndex = static_cast<int>(imgIndex); //converting size_t to integer for iteration
        ...
        string detectorType = "FAST"; //ORB,HARRIS,FAST,SHITOMASI,BRISK,AKAZE,SIFT
        ...
        if (bFocusOnVehicle)
        {
           ...
           for (int kpIndex = 0; kpIndex < keyPointsOnVehicle.size(); kpIndex++)
           {
               ...
               //if keypoint doesn't belong to preceding vehicle, remove it from vector
           ...
           cout<<"Keypoints on ONLY preceding vehicle: "<< keypoints.size()<<endl;     
        ...
        if (dataBuffer.size() > 1) // wait until at least two images have been processed
        {
            ...
            cout<< "keypoints size: " << (dataBuffer.end() - 1)->keypoints.size()<<endl;
            cout<< "keypoints size: " << (dataBuffer.end() - 2)->keypoints.size()<<endl;
